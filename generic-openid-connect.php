...
class GenericOpenIDConnect {
    ...
    public function __construct() {
        ...
        add_action( 'wp_logout', array( &$this, 'logout_form' ) );
	add_action( 'signup_form', array(&$this, 'signup_form' ) );
        if ( is_admin() ) {
            //AJAX stuff
    ...
    /**
     * wp-logout.php with openid connect
     *
     * @access public
     * @return void
     */
    public function logout_form() {
            ...
            #wp_redirect( 'https://onion.io' );
        wp_redirect( 'https://auth.onion.io/realms/onion/protocol/openid-connect/logout?redirect_uri=' . urlencode( get_site_url() )  );
            exit;

    }

    /**
     * wp-signup.php with openid connect
     *
     * @access public
     * @return void
     */
